...
public class ConnectQQActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_qq);
    ...
    private void register(String openId, String nickname) {
        ...
        RestClient.post("connect", params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers,
                ...
                try {
                    ...
                    if (status == 1) {
                        mProgress.dismiss();
                        ConnectQQActivity.this.setResult(Activity.RESULT_OK);
                        ConnectQQActivity.this.finish();
