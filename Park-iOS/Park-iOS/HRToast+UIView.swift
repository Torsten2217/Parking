...
extension UIView {
    ...
    */
    ...
    func makeToastActivity() {
        self.makeToastActivity(position: HRToastActivityPositionDefault, rootView: self as UIView)
    }

    func makeToastActivityWithMessage(message msg: String){
        self.makeToastActivity(position: HRToastActivityPositionDefault, rootView: self, message: msg)
    }
    
    func makeToastActivity(position pos: AnyObject, rootView:UIView, message msg: String = "加载中.........") {
        ...
        var activityView = UIView(frame: CGRectMake(10, 10, rootView.frame.width - 40, HRToastActivityHeight))
        ...
        activityIndicatorView.center = CGPointMake(activityView.bounds.size.width / 3, activityView.bounds.size.height / 2 + 5)
        
        // activityView.addSubview(activityIndicatorView)
        //activityIndicatorView.startAnimating()
        
        var animateView = UIImageView(frame: CGRectMake(30, activityView.frame.height/2 - 20, 40, 40))
        
        
        
        animateView.image = UIImage(named: "progress")
        
        animateView.layer.addAnimation({
        ...
        animateView.alpha = 1
        activityView.addSubview(animateView)
        ...
        if (!msg.isEmpty){
            ...
            var activityMessageLabel = UILabel(frame: CGRectMake(activityIndicatorView.bounds.origin.x + activityIndicatorView.bounds.width + 10, activityIndicatorView.frame.origin.y + 10, activityView.bounds.size.width, 20))
            
            activityMessageLabel.textColor = UIColor.grayColor()
            activityMessageLabel.font = (count(msg)<=10) ? UIFont(name:activityMessageLabel.font.fontName, size: 16) : UIFont(name:activityMessageLabel.font.fontName, size: 18)
        ...
        rootView.addSubview(activityView)
